<x-app-layout>
    ...
    <div class="bg-white rounded shadow-md border border-gray-300">
        ...
        <div class="p-4">
            ...
            <form method="GET" action="{{ route('attendance.archive') }}" class="flex flex-wrap items-center gap-2 mb-4">
                ...
                @if(request('search') || request('event_id') || request('date_filter'))
                    <a href="{{ route('attendance.archive') }}" class="text-xs text-gray-500 underline shrink-0">Reset</a>
                @endif
            </form>

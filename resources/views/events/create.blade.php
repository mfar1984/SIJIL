                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-col md:flex-row md:items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <textarea name="condition" id="condition" class="w-full text-sm border-gray-300 rounded" style="height: 380px;" placeholder="Write event terms & conditions here...">{{ old('condition') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col md:flex-row md:items-start gap-3 pt-1">
                                ...
                                <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    <x-event-toggle
                                        ...
                                        :checked="old('disable_auto_expiry')" />
                                    ...
                                    <x-event-toggle
                                        ...
                                        :checked="old('skip_identity_verification')" />
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row md:items-start gap-3 pt-2 border-t border-gray-100">
                                ...
                                <div class="flex-1 grid grid-cols-1 md:grid-cols-3 gap-2">
                                    ...
                                    <x-event-toggle
                                        ...
                                        :checked="old('auto_generate_certificate')">
                                    ...
                                    <x-event-toggle
                                        ...
                                        note="Set the scan times below, in the same pass."
                                        :checked="old('attendance_required')" />
                                </div>
                            </div>

                            {{-- Scan times, filled in from the event dates above. --}}
                            <x-attendance-picker />
                        </div>
                    </div>
                </div>

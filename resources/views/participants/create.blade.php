<x-app-layout>
    ...
    <div class="bg-white rounded shadow-md border border-gray-300">
        ...
        <div class="p-6">
            ...
            @endif
            <form method="POST" action="{{ route('participants.store') }}" class="space-y-2">
                @csrf
                <!-- Basic Information -->
                ...
                <div class="bg-white border border-gray-200 rounded-md shadow-sm">
                    <div class="bg-gray-50 border-b border-gray-200 px-4 py-3">
                        <h2 class="text-sm font-semibold text-gray-700 flex items-center">
                            <span class="material-icons-outlined text-primary-DEFAULT mr-2">note</span>
                            Notes
                        </h2>
                    </div>
                            ...
                            <div class="flex flex-col md:flex-row md:items-start gap-3">
                                <label for="notes" class="text-xs font-medium text-gray-700 md:w-40 pt-2 flex items-center gap-1">
                                    ...
                                    <div class="tooltip-wrapper" x-data="{ show: false }">
                                        ...
                                        <div x-show="show" x-transition class="tooltip-content">
                                            Internal notes about this participant (not visible to them)
                                        </div>
                                    </div>
                                </label>
                                <div class="flex-1">

<x-app-layout>
    ...
    <div class="bg-white rounded shadow-md border border-gray-300">
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('role.update', $role->id) }}" class="space-y-2">
                @csrf
                @method('PUT')
                    ...
                    <div class="p-4">
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center gap-3">
                                ...
                                <div class="flex-1">
                                    <input type="text" name="role_name" id="role_name" class="w-full text-xs border-gray-300 rounded-[1px] focus:border-primary-light focus:ring focus:ring-primary-light focus:ring-opacity-50" value="{{ old('role_name', $role->name) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row md:items-center gap-3">
                                ...
                                <div class="flex-1">
                                    <input type="text" name="role_description" id="role_description" class="w-full text-xs border-gray-300 rounded-[1px] focus:border-primary-light focus:ring focus:ring-primary-light focus:ring-opacity-50" value="{{ old('role_description', $role->description) }}">
                                </div>
                            </div>
                ...
                <div class="bg-white border border-gray-200 rounded-md shadow-sm">
                    ...
                    <div class="p-4">
                        ...
                        <x-settings.partials.permissions-matrix :permissions="$permissions" :checkedPermissionNames="$rolePermissions" mode="edit" />

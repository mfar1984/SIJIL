<x-app-layout>
    ...
    <div class="bg-white rounded shadow-md border border-gray-300">
        <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-xs text-gray-500 mt-1 ml-8">Modify user information</p>
        </div>
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('user.update', $user->id) }}" class="space-y-6">@method('PUT')
                @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <option value="government" {{ old('org_type', $user->org_type) == 'government' ? 'selected' : '' }}>Government</option>
                                </select>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    id="org_fax" 
                                    class="w-full text-xs border-gray-300 rounded-[1px] pl-12 focus:border-primary-light focus:ring focus:ring-primary-light focus:ring-opacity-50" 
                                    value="{{ old('org_fax', $user->org_fax) }}"
                                >
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    id="org_email" 
                                    class="w-full text-xs border-gray-300 rounded-[1px] pl-12 focus:border-primary-light focus:ring focus:ring-primary-light focus:ring-opacity-50" 
                                    value="{{ old('org_email', $user->org_email) }}"
                                >
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    id="org_website" 
                                    class="w-full text-xs border-gray-300 rounded-[1px] pl-12 focus:border-primary-light focus:ring focus:ring-primary-light focus:ring-opacity-50" 
                                    value="{{ old('org_website', $user->org_website) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="password" class="flex items-center text-xs font-medium text-gray-700 mb-1">
                                ...
                                Password <span class="ml-1 text-gray-400">(optional)</span>
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <p class="mt-1 text-[10px] text-gray-500">Leave empty to keep current password</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-[10px] text-gray-500">Re-enter new password if changing</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const userOrgState = "{{ $user->org_state }}";
            const userOrgCity = "{{ $user->org_city }}";
            const userOrgPostcode = "{{ $user->org_postcode }}";
            
            // Handle old form values if validation failed

<x-app-layout>
    ...
    <div class="bg-white rounded shadow-md border border-gray-300">
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('user.update', $user->id) }}" class="space-y-2">@method('PUT')
                @csrf
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    <a href="{{ route('user.management') }}" class="px-3 h-[36px] bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white rounded shadow-sm text-xs font-medium transition-colors duration-200 ease-in-out flex items-center">

                ...
                <div class="bg-white border border-gray-200 rounded-md shadow-sm">
                    ...
                    <div class="p-4">
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center gap-3">
                                <label class="text-xs font-medium text-gray-700 md:w-40 flex items-center gap-1">
                                    ...
                                    <div class="tooltip-wrapper" x-data="{ show: false }">
                                        ...
                                        <div x-show="show" x-transition class="tooltip-content">
                                            Choose the orientation for your certificate
                                        </div>
                                    </div>
                                </label>
                                <div class="flex-1">
                            ...
                            <div class="flex flex-col md:flex-row md:items-start gap-3">
                                <label for="description" class="text-xs font-medium text-gray-700 md:w-40 flex items-center gap-1 md:pt-2">
                                    ...
                                    <div class="tooltip-wrapper" x-data="{ show: false }">
                                        ...
                                        <div x-show="show" x-transition class="tooltip-content">
                                            Optional: Add a short description for this template
                                        </div>
                                    </div>
                                </label>
                                <div class="flex-1">
                            ...
                            <!-- PDF Background -->
                            <div class="flex flex-col md:flex-row md:items-center gap-3">
                                <label for="pdf_file" class="text-xs font-medium text-gray-700 md:w-40 flex items-center gap-1">
                                    PDF Background
                                    <div class="tooltip-wrapper" x-data="{ show: false }">
                                        <span class="material-icons-outlined text-gray-400 text-sm cursor-help" 
                                              @mouseenter="show = true" 
                                        ...
                                        <div x-show="show" x-transition class="tooltip-content">
                                            Upload a PDF file to use as the certificate background. Max size: 10MB
                                        </div>
                                    </div>
                                </label>
                                <div class="flex-1">
                                    <div class="flex gap-2">
                                        ...
                                        >
                                        <label for="pdf_file" class="px-4 h-9 flex items-center justify-center bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded text-xs font-medium text-gray-700 cursor-pointer">
                                            Browse
                                        </label>
                                        <input 
                                            id="pdf_file" 
